...
const CACHE_VERSION = 'v46'; // v46: cartel BONO PENDIENTE con la regla completa (#167) // v45: bono app automático también en carga manual (#165) // v44: cartel del bono app explica tope + % excedente (#164) // v43: premios de ruleta editables + tope del bono 100% (#164) // v42: rangos de reembolso con % por tipo (#163) // v41: archivar TODAS las pendientes y arrancar de 0 // v40: archivo masivo de pendientes viejos + hora/gracia del cierre + arrastre (#157) // v39: cupo por día del aprendizaje (#156) // v38: sección 🏦 Banco (bandeja en vivo, bajadas, cierre diario) + origen en Depositar (#155) // v37: card Soporte del login movida a COMANDOS (#153) // v36: aviso multicuenta por banco en modal de depósito + 🏦 en fraud banner (#152) // v32: Contexto aprendido (aprendizaje diario con confirmación) — #146
