...
// ============================================
const CACHE_VERSION = 'v64'; // v64: cartel del bono app explica tope + % excedente (#167) // v63: registro con SMS obligatorio en 2 pasos (#166) // v62: rangos con % por tipo de reembolso (#163) // v61: soporte del login/barra sin link hardcodeado (#153) // v58: modal Mis Referidos con 'cómo funciona' en 3 pasos (#143)
