...
const PROMPT = [
  ...
  '  (string). MUY IMPORTANTE: NO uses el CBU, CVU, alias ni un número de cuenta como número',
  '  de operación. Si el comprobante NO muestra un número de operación/referencia claro, poné null.',
